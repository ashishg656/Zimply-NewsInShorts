package shorts.zimply.com.zimplyshorts.serverApi;
...
public class CustomStringRequest extends StringRequest {
    ...
    public CustomStringRequest(int method, String url, String tag, AppRequestListener appRequestListener, HashMap<String, String> params) {
